export default {
    ...
    ai: {
        ...
        stop: "Stop",
        thinking: "Thinking...",
        answering: "Answering, click to interrupt",
        click_to_speak: "Click to Speak",
        too_short: "Speech too short",
        mic_permission_fail: "Failed to obtain microphone permission",
        audio_file_fail: "Audio file processing failed",
        no_audio: "No audio detected",
        parse_text_fail: "Failed to parse text",
        fetch_text_fail: "Failed to retrieve text",
        please_wait: "Please wait",
        already_latest: "Already the latest conversation",
        recording: "Recording...",
